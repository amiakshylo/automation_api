...
import requests
from utils.http_methods_for_google_api import HttpMethod
...
class Google_maps_api:
    ...
    def create_new_place():
        ...
        print(post_url)
        post_request = HttpMethod.post(post_url, json_for_creating_new_location)
    ...
    def get_new_place(place_id):
        ...
        print(get_url)
        get_request = HttpMethod.get(get_url)
    ...
    def change_new_place(place_id):
        ...
        print(put_url)
        put_request = HttpMethod.put(put_url, json_for_changing_location)
    ...
    def delete_new_place(place_id):
        ...
        delete_request = HttpMethod.delete(delete_url, json_for_delete_location)
